! ADCC-NAGARCH(1,1) Student-t with variance targeting: two-stage estimation on N assets.
!
...
! Stage 2: ADCC(1,1) Student-t correlation, np=4 (a, b, g, nu).
!
! n_params = 3*N + 4.
...
! working scalars
real(dp) :: alpha_n, theta_n, beta_n, omega, sample_var, persist, fopt
...
total_logl = logl_s2 - 0.5_dp * h_logsum
np_total   = ncols*3 + 4
