...
module model_selection_mod
    ...
    public :: model_summary_order, print_model_selection_counts
...
contains
    ...
    subroutine print_model_selection_counts(model_names, param_count, aic_wins, bic_wins, aic_symbols, &
        ...
        do iord = 1, size(order)
            imod = order(iord)
            if (have_rank .and. rank_count(imod) > 0) then
...
module garch_forecast_mod
    ...
    use garch_fit_mod,   only: riskmetrics2006_variance, garch_skew_kurt, nagarch_skew_kurt, gjr_skew_kurt, &
...
! ===== begin xfit_gen_garch_returns.f90 =====
...
program xfit_gen_garch_returns
    ...
    use garch_fit_mod,  only: fit_symm_garch, fit_nagarch, fit_gjr, fit_fgarch_twist, fit_aparch, fit_harch, &
                              fit_riskmetrics2006, &
    ...
    character(len=16), parameter :: models(*) = [character(len=16) :: &
        "SYMM_GARCH", "NAGARCH", "GJR_GARCH", "FGTWIST", "APARCH", "HARCH", "RM2006", "MIDASHYP", "MIDASHYP_ASYM"]
...
! ===== end xfit_gen_garch_returns.f90 =====
