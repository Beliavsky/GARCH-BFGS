! Fit standard GJR-GARCH(1,1)-Normal to the ETF return panel.
...
program xfit_gjr_returns
    ...
    use garch_fit_mod, only: fit_gjr, gjr_skew_kurt, gjr_persist
    implicit none
